...
import { OccasionSlider, PoetSlider } from "../Common/Slider";import AppImage from "../../components/AppImage";
        ...
        <div className="bg-black min-h-screen text-white">
          ...
          <div className="relative bg-gradient-to-b from-blue-700 to-black min-h-[400px] flex items-center p-8 md:p-16 text-white">
            ...
            <div className="relative h-40 w-40 overflow-hidden rounded-lg shadow-lg md:h-60 md:w-60">
              <AppImage src={occasionData?.image ?? Prouser} alt={occasionData?.name} fill sizes="(max-width: 768px) 160px, 240px" className="object-cover transition-transform hover:scale-105" />
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0d2b80] via-black to-black text-white px-6 py-12 flex flex-col items-center animate-slide-up">
      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl shadow-2xl max-w-5xl w-full p-8 flex flex-col md:flex-row gap-8">
        {/* Left - Poster */}
        <AppImage src={occasionData.image} alt={occasionData.name} width={288} height={288} className="h-72 w-72 rounded-2xl object-cover shadow-lg transition-transform duration-500 hover:scale-105" />
