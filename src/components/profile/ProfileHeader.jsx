  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-[#2f2f2f] bg-gradient-to-br from-[#141414] via-[#0f0f0f] to-[#0b0b0b] p-5 md:p-7">
      ...
      <div className="relative mt-6 grid grid-cols-3 gap-3 md:max-w-md">
        ...
        <StatPill label="Followers" value={profileData?.followers || 0} onClick={onFollowersClick} />
        <StatPill label="Following" value={profileData?.following || 0} onClick={onFollowingClick} />
      </div>
    </section>
  );
};
